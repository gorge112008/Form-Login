...
import routerLogin from "./routes/api/login.routes.js";
import routerRegister from "./routes/api/register.routes.js";
...
app.use("/api", routerLogin, routerRegister, routerCarts, routerMessage, routerUser, routerProducts);//Configurar el servidor para que pueda entender las rutas de la API
